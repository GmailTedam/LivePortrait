...
class LivePortraitPipeline(object):
    ...
    def execute(self, args: ArgumentConfig):
        ...
        if flag_is_source_video:
            log("Start making source motion template...")
        ...
        if flag_is_driving_video or (
            ...
            log("The output of image-driven portrait animation is an image.")
        for i in track(range(n_frames), description="🚀Animating...", total=n_frames):
            ...
            if (
                ...
                if flag_normalize_lip and lip_delta_before_animation is not None:
                    x_d_i_new = (
                        self.live_portrait_wrapper.stitching(x_s, x_d_i_new)
                        + lip_delta_before_animation
                    )
                else:
